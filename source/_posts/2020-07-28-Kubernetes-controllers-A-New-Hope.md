...
{% img /images/kubernetes-controllers-a-new-hope/kubernetes-controllers-a-new-hope-1.png "Plugin system" %}
...
{% img /images/kubernetes-controllers-a-new-hope/kubernetes-controllers-a-new-hope-2.png "kube-controller-manager including the plugin system" %}
...
{% img /images/kubernetes-controllers-a-new-hope/kubernetes-controllers-a-new-hope-3.png %}
...
{% img /images/kubernetes-controllers-a-new-hope/kubernetes-controllers-a-new-hope-4.png %}
