...
![Example architecture using Vert.x Web](/img/tutorial-debts-manager/vertx-web-1.png "Example architecture using Vert.x Web")
...
![Example architecture using Vert.x Web & Vert.x Web API Contract](/img/tutorial-debts-manager/vertx-web-2.png "Example architecture using Vert.x Web & Vert.x Web API Contract")
...
![Example architecture using Vert.x Web & Vert.x Web API Contract & Vert.x Web API Service](/img/tutorial-debts-manager/vertx-web-3.png "Example architecture using Vert.x Web & Vert.x Web API Contract & Vert.x Web API Service")
...
![Vert.x Starter screenshot](/img/tutorial-debts-manager/vertx-starter-screenshot.png "Vert.x Starter screenshot")

Let's dig into the generated code:

![Vert.x Starter generated code tree](/img/tutorial-debts-manager/generated-code-tree.png "Vert.x Starter generated code tree")
