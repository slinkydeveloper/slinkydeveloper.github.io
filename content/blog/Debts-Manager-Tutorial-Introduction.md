...
1. **[Contract design](./Debts-Manager-Tutorial-Contract-Design)**: Design the OpenAPI 3 contract
2. **[Vert.x Web API Contract & Service](./Debts-Manager-Tutorial-Vert-x-Web-API-Contract-Service)**: Setup Vert.x project and bind Vert.x Event Bus services
